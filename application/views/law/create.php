                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <form class="form-horizontal" id="uu_form_create" action="<?php echo site_url('law/do_create') ?>" method="post">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="reference" type="text" class="form-control" placeholder="Referensi">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.box-body -->

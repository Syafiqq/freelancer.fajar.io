...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/frontend/test/css/test.css') ?>">
...
<script src="<?php echo base_url('assets/frontend/bower_components/initializr/js/plugins.js') ?>"></script>
<script src="<?php echo base_url('assets/frontend/test/js/test.js') ?>"></script>
